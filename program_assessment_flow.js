  ...
  @media (min-width: 1200px) {
    .competition_item#competition_step1 > div {
      ...
      <section class="consultation_descr_box">
        <h2>Book a Free <span class="grade_var">Grade 12</span> Consultation</h2>
        <div>
        ...
        entries.forEach((i) => {
          if (i.isIntersecting) {
            ...
            if (i.target.classList.contains("our_consultants_wrapper")) {
              pushDataLayer("exp_bookpage_viewel_03", "Interaction", "View element on screen", "Schedule a Complimentary");
            }
